var countDown = new Date("Dec 31,2019 00:00:00").getTime();
var countFunction = setInterval(function () {
    ...
    // document.getElementById('count').innerHTML = day + " DAY" + hour + " HOUR" + minutes + " MINUTES" + second + " SECOND";
...
document.querySelector('.button').onmousemove = (e) => {
    ...
    $(function () {
        var typed = new Typed('.main-text', {
            strings: ["COMING SOON", "មកដល់ឆាប់ៗនេះ"],
            loop: true,
            typeSpeed: 20
        });
    });
